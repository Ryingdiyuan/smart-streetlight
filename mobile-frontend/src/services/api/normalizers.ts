...
export function mapDevicePayload(payload: DeviceApiPayload): Device {
  return {
    ...
    location: payload.location ?? "未设置位置",
...
export function mapThresholdPayload(payload: ThresholdConfigApiPayload, deviceCode?: string): ThresholdConfig {
  return {
...
export function mapCommandLogPayload(payload: ControlLogApiPayload, deviceCode?: string): CommandLog {
  return {
