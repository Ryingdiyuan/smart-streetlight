  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { title: "设备列表", roles: allRoles },
        },
        {
          path: "devices/:id",
          name: "device-detail",
        ...
        },
        {
          ...
          name: "alarms",
          component: AlarmPage,
          meta: { title: "告警日志", roles: allRoles },
        },
        {
          path: "agent",
          name: "agent",
          component: AgentPage,
          meta: { title: "智能问答", roles: allRoles },
        },
        {
          path: "realtime-light",
          name: "realtime-light",
          component: RealtimeLightPage,
          meta: { title: "实时光照监测", roles: allRoles },
        },
        {
          path: "light-history",
          name: "light-history",
        ...
        },
        {
          ...
          meta: { title: "用户管理", roles: adminOnly },
        },
        {
          path: "forbidden",
          name: "forbidden",
